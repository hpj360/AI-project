...
version: 1
ratings:
  vivino: {score: 4.8, votes: 20587}
  diffords: {score: 4.42, year: 2021}
...
source_url: https://iba-world.com/iba-cocktail/word/
...
IBA 官方 难忘杯（The Unforgettables） 系列鸡尾酒 Last Word（最后一言），以 Gin、Green Chartreuse、Maraschino、Fresh Lime Juice 调制，摇和入鸡尾酒杯。
...
- **原料**：Gin、Green Chartreuse、Maraschino、Fresh Lime Juice
- **酿造方法**：
