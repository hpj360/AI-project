...
version: 1
ratings:
  vivino: {score: 4.8, votes: 12669}
  parker: {score: 88, year: 2020}
  wine_spectator: {score: 87, year: 2021}
  cellar_tracker: {score: 4.8, votes: 34}
awards:
  - {name: IWSC Silver, year: 2019, org: IWSC}
source_url: https://world.openfoodfacts.org/product/to
...
OpenFoodFacts 真实产品数据：El Pescaíto（Vicente Gandía）

## 图片参考

- [WikiMedia Commons](https://commons.wikimedia.org/w/index.php?search=El%20Pesca%C3%ADto%20wine_white%20bottle&title=Special:MediaSearch&type=image)
- [Unsplash 图库](https://unsplash.com/s/photos/El%20Pesca%C3%ADto%20wine_white)
- [Google 图片](https://www.google.com/search?q=El%20Pesca%C3%ADto%20wine_white%20bottle&tbm=isch)
