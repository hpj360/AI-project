...
version: 1
ratings:
  vivino: {score: 4.8, votes: 35324}
  diffords: {score: 4.45, year: 2022}
...
source_url: https://iba-world.com/iba-cocktail/saturn/
...
IBA 官方 新时代（New Era Drinks） 系列鸡尾酒 Saturn（土星），以 Gin、Lemon Juice、Orgeat Syrup、Falernum、Passion Fruit Syrup 调制，摇和入鸡尾酒杯。
...
- **原料**：Gin、Lemon Juice、Orgeat Syrup、Falernum、Passion Fruit Syrup
- **酿造方法**：
...
| Orgeat Syrup | 15 | ml |
| Falernum | 10 | ml |
| Passion Fruit Syrup | 5 | ml |

- **调制技法**：摇和
- **难度**：★★☆☆☆ 简单
- **装饰**：Lemon twist and cherry
- **用冰类型**：方块冰
- **风味平衡**：均衡
- **适饮季节**：四季
- **适饮场合**：餐前
