...
version: 1
ratings:
  vivino: {score: 4.8, votes: 31536}
  wine_enthusiast: {score: 86, year: 2022}
source_url: https://world.openfoodfacts.org/product/limitada
...
OpenFoodFacts 真实产品数据：Tequila blanco (edicion limitada)（Tiscaz）

## 图片参考

- [WikiMedia Commons](https://commons.wikimedia.org/w/index.php?search=Tequila%20blanco%20%28edicion%20limitada%29%20tequila%20bottle&title=Special:MediaSearch&type=image)
- [Unsplash 图库](https://unsplash.com/s/photos/Tequila%20blanco%20%28edicion%20limitada%29%20tequila)
- [Google 图片](https://www.google.com/search?q=Tequila%20blanco%20%28edicion%20limitada%29%20tequila%20bottle&tbm=isch)

## 基础信息

- **中文名**：Tequila blanco (edicion limitada)
- **外文名**：Tequila blanco (edicion limitada)
- **别名**：Tiscaz
- **分类**：龙舌兰
- **产地**：未知
- **生产商**：Tiscaz
