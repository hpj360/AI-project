...
version: 1
ratings:
  vivino: {score: 4.0, votes: 24877}
  wine_enthusiast: {score: 81, year: 2021}
source_url: https://world.openfoodfacts.org/product/cointreau
...
OpenFoodFacts 真实产品数据：Cointreau（Cointreau）

## 图片参考

- [WikiMedia Commons](https://commons.wikimedia.org/w/index.php?search=Cointreau%20liqueur%20bottle&title=Special:MediaSearch&type=image)
- [Unsplash 图库](https://unsplash.com/s/photos/Cointreau%20liqueur)
- [Google 图片](https://www.google.com/search?q=Cointreau%20liqueur%20bottle&tbm=isch)
...
- **分类**：利口酒
- **产地**：未知
- **生产商**：Cointreau, Maison Cointreau
- **酒精度**：未知
- **容量**：700ml
- **参考价格（RMB）**：¥50-300
- **价格档位**：daily
