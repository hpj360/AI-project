...
IBA 官方 当代经典（Contemporary Classics） 系列鸡尾酒 Bellini（贝里尼），以 Prosecco、White Peach Puree 调制，摇和入笛型杯。
...
- **佐餐搭配**：小食
- **鸡尾酒应用**：餐前
- **饮用建议**：将白桃果泥倒入冰镇笛型杯，缓慢注入普罗塞克起泡酒，轻轻搅和。
