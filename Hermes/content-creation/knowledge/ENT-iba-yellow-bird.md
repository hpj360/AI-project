...
version: 1
ratings:
  vivino: {score: 4.4, votes: 41216}
  diffords: {score: 4.12, year: 2020}
  iba: {score: 4.1, year: 2021}
source_url: https://iba-world.com/iba-cocktail/bird/
...
IBA 官方 新时代（New Era Drinks） 系列鸡尾酒 Yellow Bird（黄鸟），以 White Rum、Galliano、Triple Sec、Lime Juice 调制，摇和入鸡尾酒杯。

## 图片参考

- [WikiMedia Commons](https://commons.wikimedia.org/w/index.php?search=Yellow%20Bird%20cocktail%20bottle&title=Special:MediaSearch&type=image)
- [Unsplash 图库](https://unsplash.com/s/photos/Yellow%20Bird%20cocktail)
- [Google 图片](https://www.google.com/search?q=Yellow%20Bird%20cocktail%20bottle&tbm=isch)
...
- **原料**：White Rum、Galliano、Triple Sec、Lime Juice
- **酿造方法**：
